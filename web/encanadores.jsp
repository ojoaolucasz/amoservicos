    ...
    <body>
        ...
        <%
            ...
            try{
                ...
                rs = st.executeQuery("SELECT * FROM empresas WHERE especialidade = 'Encanador';");
                 while(rs.next()){
                    %>
                    <div class="col-md-3">
                        <div class="card" style="width: 18rem;">
                            <img src="images/<%=rs.getString("logo")%>" class="card-img-top" alt="..." width="286px" height="180px"s>
                            <div class="card-body">
