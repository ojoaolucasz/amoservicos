    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            try{
                ...
                rs = st.executeQuery("SELECT * FROM public.empresas");
                 while(rs.next()){
                 String id = rs.getString("id");
                    ...
                    %>            
                          <tr>
                            ...
                            <td class="d-flex justify-content-center"><img src="../images/<%=rs.getString("logo")%>" alt="alt" width="50px" height="50px"/></td>
                            <td>
                                              ...
                                              <div class="modal-dialog">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-body">
                                                      <form class="row g-3" action="config/editaEmpresaAdmin.jsp?id=<%out.println(id);%>" method="POST">
                                                            <div class="col-12">
                                            ...
                                            <div class="modal fade" id="modalExcluir<% if(id==id)out.print(id); %>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                              <div class="modal-dialog">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                                    <a href="config/deletaEmpresaAdmin.jsp?funcao=excluir&id=<%=rs.getString("id")%>" class="btn btn-danger">Excluir</a>
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
